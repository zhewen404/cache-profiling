...
scheme_to_color = {
    ...
    "XORCache+BDI(LSH-RP)": px.colors.qualitative.Vivid[2],
    ...
    "XORCache+BDI(LSH-BS)": px.colors.qualitative.Vivid[3],
    ...
    "XORCache+BDI(BL)": px.colors.qualitative.Vivid[1],
    ...
    "XORCache+BDI(SBL)": px.colors.qualitative.Vivid[7],
...
scheme_to_name = {
    ...
    "XORCache+BDI(BL)": "shuffledbytemap-banked",
    ...
    "XORCache+BDI(SBL)": "sparseshuffledbytemap_8_6-banked",
