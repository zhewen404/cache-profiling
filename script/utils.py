...
scheme_to_color = {
    ...
    "thesaurus-bank": px.colors.qualitative.Vivid[2],
    ...
    "bytemap-shuffle-xorfold-bank": px.colors.qualitative.Vivid[1],
    ...
    "sparsebytemap(8,6)-shuffle-xorfold-bank": px.colors.qualitative.Vivid[7],
    ...
    "EPC word labeling-bank": px.colors.qualitative.Vivid[6],
    "strong word labeling": px.colors.qualitative.Vivid[10],
    "hycomp word labeling": px.colors.qualitative.Vivid[0],
    "hycomp word labeling-bank": px.colors.qualitative.Vivid[0],
...
scheme_to_name = {
    ...
    "thesaurus": "thesaurus",
    "thesaurus-bank": "thesaurus-banked",
    ...
    "bytemap-shuffle-xorfold-bank": "shuffledbytemap-banked",
    ...
    "sparsebytemap(8,6)-shuffle-xorfold-bank": "sparseshuffledbytemap_8_6-banked",
    ...
    "EPC word labeling-bank": "epc_word_labeling-banked",
    "strong word labeling": "strong_word_labeling",
    "hycomp word labeling": "hycomp_word_labeling",
    "hycomp word labeling-bank": "hycomp_word_labeling-banked",
