    ...
    bool use_little_endian, bool allow_immo)
{
    ...
    xorIdealBankCache = new IdealBankXORCache(*cache, new BDICompressor(use_little_endian, allow_immo));
    ...
    bool use_little_endian, bool allow_immo)
{
    ...
    IdealSetXORCache * xorIdealSetCache;
    xorIdealSetCache = new IdealSetXORCache(*cache, new BDICompressor(use_little_endian, allow_immo));
